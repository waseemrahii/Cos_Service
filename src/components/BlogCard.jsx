    ...
    <div className="col-lg-4 col-md-6 mb-4">
      <div className="blog-box box-sm shadow-sm" style={{ minHeight: '450px' }}>
        <div className="img-box overflow-hidden rounded" style={{ height: '250px' }}>
          ...
          />
          <div className="date position-absolute" style={{ background: '#E20613', color: '#fff', padding: '10px', textAlign: 'center', borderRadius: '5px' }}>
        ...
        <div className="text-box p-3 text-start">
          ...
          <Link to={`/blogdetails/${blog._id}`} className="read-more" style={{ color: '#E20613' }}>
